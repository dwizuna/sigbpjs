        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
			...
			<?php if($this->session->userdata('jt')=='admin' || $this->session->userdata('jt')=='operator'){ ?>
				<li class="<?php if($this->session->userdata('option')!='dashboard'&&$this->session->userdata('option')!='user'&&$this->session->userdata('option')!='setting') echo 'active';?> treeview">
				  <a href="<?php echo base_url();?>dashboard">
					...
					<div class="row">
						<div class="col-lg-3 col-xs-6">
						  ...
						  <div class="small-box bg-green">
							<div class="inner">
							  <h3><?php echo $this->session->userdata('jml_faskes');?></h3>
							...
							<a href="<?php echo site_url('dashboard/faskes')?>" class="small-box-footer">
						...
						<div class="col-lg-3 col-xs-6">
						  ...
						  <div class="small-box bg-red">
							<div class="inner">
							  <h3><?php echo $this->session->userdata('jml_category');?></h3>
							...
							<a href="<?php echo site_url('dashboard/jenis')?>" class="small-box-footer">
							  Detail <i class="fa fa-arrow-circle-right"></i>
							</a>
						  </div>
						</div>
						...
						<div class="col-lg-3 col-xs-6">
						  ...
						  <div class="small-box bg-yellow">
							...
							<a href="../" class="small-box-footer" target="blank">
